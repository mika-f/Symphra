...
pub use expression::{
    ...
    RestExpression, SampleChoiceAlternative, SampleSelectorExpression, SequenceItem, StepItem,
    VelocityExpression,
};
...
pub use statement::{
    ...
    PanExpression, PlaySource, PlayStatement, ProjectStatement, RepeatExpression,
